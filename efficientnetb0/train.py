...
parser.add_argument('--data_path', type=str, metavar='DIR', default='/home/twang/BDCI2021/train', help='path to dataset')
parser.add_argument('--dataset', type=str, default='bdci', choices=['ImageNet', 'CIFAR10', 'bdci'],
                    help='ImageNet, CIFAR10 or bdci')
parser.add_argument('--distributed', action='store_true', default=False)
parser.add_argument('--platform', type=str, default='GPU', choices=('GPU', 'CPU', 'Ascend'), help='run platform')
...
def main():
    ...
    if cfg.save_checkpoint:
        config_ck = CheckpointConfig(
            save_checkpoint_steps=batches_per_epoch * EPOCH_PER_CKPT, keep_checkpoint_max=cfg.keep_checkpoint_max)
        ckpoint_cb = ModelCheckpoint(
            prefix=cfg.model, directory='../ckpt', config=config_ck)
